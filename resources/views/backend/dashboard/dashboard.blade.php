                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <a href="#" class="text-decoration-none">View net earnings</a>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <a href="#" class="text-decoration-none text-white-50">View all
                                                orders</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <a href="#" class="text-decoration-none">Withdraw money</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
