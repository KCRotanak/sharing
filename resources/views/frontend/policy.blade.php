...
<div class="class-name text-justify" style="margin-top:150px; margin-left:7%; margin-right:5%; margin-bottom:200px">
    <h1 class="primary--text d-flex justify-center">Privacy Policy</h1>
    <br />
    ...
    <div>
        ...
        it. After approval of your comment, your
        profile picture is visible to the public in the context of your comment.
    </div>
    <br />
    <h5>Who we share your data with & How long we retain your data?</h5>
    <div>
